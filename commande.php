...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Orders</title>
            ...
            <div class='quick-area'>
                ...
                <div class='pull-right'>
                    <ul class="info-menu right-links list-inline list-unstyled">
                        <li class="profile">
                            <a href="#" data-toggle="dropdown" class="toggle">
                                <img src="data/profile/profile-university.jpg" alt="user-image" class="img-circle img-inline">
                    ...
                    <div class="profile-info row">
                        ...
                        <div class="profile-image col-md-4 col-sm-4 col-xs-4">
                            <a href="ui-profile.html">
                                <img src="data/profile/profile-university.jpg" class="img-responsive img-circle">
                            </a>
                        </div>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                <li>
                                    <a class="active" href="uni-order.php" >Orders placed</a>
                                </li>
                                <li>
                                    <a class="" href="uni-coupon.php" >All coupon</a>
                                </li>
                                <li>
                                    <a class="" href="uni-coupon-add.php" >Add coupon</a>
                                </li>
                        ...
                        <div class="page-title">
                            ...
                            <div class="pull-right hidden-xs">
                                <ol class="breadcrumb">
                                    ...
                                    <li>
                                        <a href="uni-coupon.php">Purchases</a>
                                    </li>
                                    <li class="active">
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Order</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                <th>ID</th><th>NOM PRODUIT</th> <th>PRIX UNITAIRE</th>  <th>PRIX TOTAL</th> <th>DATE</th>    </tr>
                                            </thead>
