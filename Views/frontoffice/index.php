			...
			<div class="row">
				<div class="col">
					<div class="product-grid" data-isotope='{ "itemSelector": ".product-item", "layoutMode": "fitRows" }'>
						...
						?>
						<div class="product-item <?=$Produit['nom'];?>">
							<div class="product discount product_filter">
								...
								<div class="product_info">
									<h6 class="product_name"><a href="single.html"><?=$Produit['Taille'];?></a></h6>
									<h6 class="product_name">taille : <a href="single.html"><?=$Produit['Prix'];?></a></h6>
									<div class="product_price">$<?=$Produit['Genre'];?></div>
								</div>
							</div>
